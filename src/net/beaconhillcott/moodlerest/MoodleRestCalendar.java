...
public class MoodleRestCalendar implements Serializable {
  ...
  public static MoodleCalendar[] createCalendarEvents(MoodleCalendar[] calendar) throws MoodleRestException, UnsupportedEncodingException {
    ...
    for (int i=0;i<calendar.length;i++) {
      ...
      if (calendar[i].getFormat()==null) throw new MoodleRestCalendarException(MoodleRestException.REQUIRED_PARAMETER+" format"); else data.append("&").append(URLEncoder.encode("events["+i+"][format]", MoodleServices.ENCODING.toString())).append("=").append(URLEncoder.encode(""+calendar[i].getFormat(), MoodleServices.ENCODING.toString()));
      if (calendar[i].getCourseId()==null) throw new MoodleRestCalendarException(MoodleRestException.REQUIRED_PARAMETER+" courseid"); else data.append("&").append(URLEncoder.encode("events["+i+"][courseid]", MoodleServices.ENCODING.toString())).append("=").append(URLEncoder.encode(""+calendar[i].getCourseId(), MoodleServices.ENCODING.toString()));
      if (calendar[i].getGroupId()==null) throw new MoodleRestCalendarException(MoodleRestException.REQUIRED_PARAMETER+" groupid"); else data.append("&").append(URLEncoder.encode("events["+i+"][groupid]", MoodleServices.ENCODING.toString())).append("=").append(URLEncoder.encode(""+calendar[i].getGroupId(), MoodleServices.ENCODING.toString()));
      if (calendar[i].getRepeats()==null) throw new MoodleRestCalendarException(MoodleRestException.REQUIRED_PARAMETER+" repeats"); else data.append("&").append(URLEncoder.encode("events["+i+"][repeats]", MoodleServices.ENCODING.toString())).append("=").append(URLEncoder.encode(""+calendar[i].getRepeats(), MoodleServices.ENCODING.toString()));
      if (calendar[i].getEventtype()==null) throw new MoodleRestCalendarException(MoodleRestException.REQUIRED_PARAMETER+" eventtype"); else data.append("&").append(URLEncoder.encode("events["+i+"][eventtype]", MoodleServices.ENCODING.toString())).append("=").append(URLEncoder.encode(calendar[i].getEventtype(), MoodleServices.ENCODING.toString()));
      if (calendar[i].getTimestart()==null) throw new MoodleRestCalendarException(MoodleRestException.REQUIRED_PARAMETER+" timestart"); else data.append("&").append(URLEncoder.encode("events["+i+"][timestart]", MoodleServices.ENCODING.toString())).append("=").append(URLEncoder.encode(""+calendar[i].getTimestart(), MoodleServices.ENCODING.toString()));
      if (calendar[i].getTimeduration()==null) throw new MoodleRestCalendarException(MoodleRestException.REQUIRED_PARAMETER+" timeduration"); else data.append("&").append(URLEncoder.encode("events["+i+"][timeduration]", MoodleServices.ENCODING.toString())).append("=").append(URLEncoder.encode(""+calendar[i].getTimeduration(), MoodleServices.ENCODING.toString()));
      if (calendar[i].getVisible()==null) throw new MoodleRestCalendarException(MoodleRestException.REQUIRED_PARAMETER+" visible"); else data.append("&").append(URLEncoder.encode("events["+i+"][visible]", MoodleServices.ENCODING.toString())).append("=").append(URLEncoder.encode(""+calendar[i].getVisible(), MoodleServices.ENCODING.toString()));
      if (calendar[i].getSequence()==null) throw new MoodleRestCalendarException(MoodleRestException.REQUIRED_PARAMETER+" sequence"); else data.append("&").append(URLEncoder.encode("events["+i+"][sequence]", MoodleServices.ENCODING.toString())).append("=").append(URLEncoder.encode(""+calendar[i].getSequence(), MoodleServices.ENCODING.toString()));
    }
    data.trimToSize();
